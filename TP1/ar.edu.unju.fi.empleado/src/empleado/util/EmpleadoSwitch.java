 ...
 * @generated
 */
public class EmpleadoSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	protected static EmpleadoPackage modelPackage;
	 ...
	 * @generated
	 */
	public EmpleadoSwitch() {
		if (modelPackage == null) {
			modelPackage = EmpleadoPackage.eINSTANCE;
		}
	}
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case EmpleadoPackage.PERSONA: {
				Persona persona = (Persona)theEObject;
				T result = casePersona(persona);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case EmpleadoPackage.USUARIO: {
				Usuario usuario = (Usuario)theEObject;
				T result = caseUsuario(usuario);
				if (result == null) result = casePersona(usuario);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case EmpleadoPackage.DOMICILIO: {
				Domicilio domicilio = (Domicilio)theEObject;
				T result = caseDomicilio(domicilio);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case EmpleadoPackage.RESPONSABLE: {
				Responsable responsable = (Responsable)theEObject;
				T result = caseResponsable(responsable);
				if (result == null) result = casePersona(responsable);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Domicilio</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Domicilio</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseDomicilio(Domicilio object) {
		return null;
	}
